...
-   Allows subclasses to change/add methods without affecting super class
...
-   Part of the _Dependency Inversion Principle_: High level modules should not depend on low level modules, they should depend on abstractions
